...
public class Gnaix {
    ...
    public String getResponse(String input) {
        ...
        switch (parsed.getCommand()) {
            ...
            case DEADLINE:
            case EVENT:
                assert parsed.getTask() != null : "Task command should contain a parsed task";
            ...
            case DATE:
                assert parsed.getDate() != null : "Date command should contain a parsed date";
                return getDateResponse(parsed.getDate());
            case FIND:
                assert parsed.getKeyword() != null : "Find command should contain a parsed keyword";
